...
If TxtDID <> "" Then
    strSQL = "EXEC QSMS_Record_BIOSOrEC @DID ='" & Trim(TxtDID) & "',@Model ='" & Trim(TxtModel) & "',@Line ='" & Trim(TxtLine) & "',@Machine ='" & Trim(TxtMachine) & "',@Qty ='" & Trim(TxtQty) & "'," & _
       ...
       Conn.Execute (strSQL)
       ''Call reFreshData
       MsgBox "Delete Successfully", vbOKOnly Or vbInformation, "System Prompt"
       TxtDID = ""
       TxtModel = ""
       TxtMachine = ""
       TxtQty = ""
...
If TxtDID = "" Or TxtTime = "" Or TxtMachine = "" Then
       MsgBox "The input data cannot have empty values, please confirm again!", vbOKOnly Or vbInformation, "System Prompt"
       TxtMachine = ""
       TxtTime = ""
       TxtDID = ""
       TxtDID.SetFocus
...
Else
       ...
       If RS.EOF Then
            ...
            Conn.Execute (strSQL)
            Call reFreshData
            MsgBox "OK", vbOKOnly Or vbInformation, "System Prompt"
            TxtDID = ""
            TxtModel = ""
            TxtMachine = ""
            TxtQty = ""
            ...
            TxtTime = ""
      Else
          MsgBox "The DID exists, please check again!", vbOKOnly Or vbInformation, "System Prompt"
      End If
End If
End Sub
