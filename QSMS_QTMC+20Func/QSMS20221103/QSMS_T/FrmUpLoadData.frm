        ...
        If RS.EOF = False Then
            Do While Not RS.EOF
                ...
                If Abs(DateDiff("n", XLJobDatetime, XLplanTime)) < 15 Then
                    MsgBox ("请不要在XLJob执行的15分钟前后上传XL_WOPlanSeq！")
                    Exit Sub
                End If
                RS.MoveNext
            Loop
        Else
            ...
            If Not RS.EOF Then
                ...
                If DateDiff("n", XLJobDatetime, XLplanTime) < 30 Then
                    MsgBox ("请不要在XLJob执行的30分钟内上传XL_WOPlanSeq！")
                    Exit Sub
                End If
            End If
                ...
                If blerr = False Then
                    ...
                    If Trim(tmpSide) = "" Then
                        ...
                        If rsTmp.EOF = False Then
                            ...
                            .Cells(tmpRow, 10) = "Upload Fail: 同一个PCBGroup已经上传一个工单，对于同一个PCBGroup的工单，如果Date/Shift/Line/Factory相同.仅需上传其中一个工单即可！"
                ...
                If blerr = False Then
                    ...
                    If Trim(tmpSide) = "" Then
                        ...
                        If rsTmp.EOF = False Then
                            ...
                            .Cells(tmpRow, 10).Interior.ColorIndex = 3
                            .Cells(tmpRow, 10).Interior.Pattern = xlSolid '0060
                            .Cells(tmpRow, 10) = "Upload Fail: 同一个PCBGroup已经上传一个工单，对于同一个PCBGroup的工单，如果Date/ShiftID/Line/Factory相同.仅需上传其中一个工单即可！"
...
'                MsgBox "File Format Error: " & sColHead & " !!", vbExclamation, "Prompt"
                MsgBox "上传Excel文件的格式错误，正确的文件格式应该是：" & sColHead & "", vbExclamation, "Prompt"
                GoTo Normal_Exit
            End If
        Next intCol
