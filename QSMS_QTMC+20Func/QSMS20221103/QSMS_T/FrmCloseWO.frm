   ...
   Begin VB.Frame FraFile 
      ...
      Begin VB.Frame frameCHK 
         ...
         Begin VB.Label Label2 
            AutoSize        =   -1  'True
            Caption         =   "Check if dispatch finished(检查是否已经全部发料)"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.Label Label5 
            AutoSize        =   -1  'True
            Caption         =   "Check if AOI finished(检查AOI数量是否匹配)"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.Label Label5 
            AutoSize        =   -1  'True
            Caption         =   "Check if all has sent SAP1(检查是否所有数据已送SAP1)"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.Label Label5 
            AutoSize        =   -1  'True
            Caption         =   "Check if wo has sent SAP2(检查此工单是否已关闭过)"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
...
If StrBU = "PO" Then
    Label2.Caption = "Check if dispatch finished(浪琩琌竒场祇)"
    Label5(0).Caption = "Check if AOI finished(浪琩AOI计秖琌で皌)"
    Label5(1).Caption = "Check if all has sent SAP1(浪琩琌┮Τ计沮癳SAP1)"
    Label5(2).Caption = "Check if wo has sent SAP2(浪琩虫琌闽超筁)"
End If
End Sub
