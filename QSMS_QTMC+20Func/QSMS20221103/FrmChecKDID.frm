...
If BeginDate <> "" And EndDate <> "" Or Trim(TxtDID) <> "" Then
   ...
   End If
Else
    MsgBox "The query condition cannot be empty.", vbOKOnly Or vbInformation, "System Prompt"
    Exit Sub
End If
End Sub
...
If Trim(TxtDID) <> "" And KeyAscii = 13 And Len(TxtDID) <= "30" Then
    If strChkDIDByLine = "Y" Then  ''1276
       If CboLine.Text = "" Then
          MsgBox "Please select the line.", vbOKOnly Or vbInformation, "System Prompt"
          Exit Sub
       End If
    End If
    TxtBarcode.SetFocus
...
If Len(TxtDID) > "30" And KeyAscii = 13 Then
    MsgBox "Please enter the correct DID", vbOKOnly Or vbInformation, "System Prompt"
    TxtDID = ""
    TxtBarcode = ""
    TxtDID.SetFocus
End If
...
If KeyAscii = 13 And Trim(TxtBarcode) <> "" Then
          ...
          If strChkDIDByLine = "Y" And CboLine.Text <> "All" Then ''1276 then
            ...
            Else
               If strGroupID <> Trim(rs.Fields("GroupID")) Then
                  Call Err_Sound
                  MsgBox "GroupIDs of adjacent DIDs are inconsistent£¡", vbOKOnly Or vbInformation, "System Prompt"
                  TxtDID = ""
                  TxtBarcode = ""
                  TxtDID.SetFocus
                  Exit Sub
     ...
     Else
        Call Err_Sound
        MsgBox Trim(rs.Fields("Desc")), vbOKOnly Or vbInformation, "System Prompt"
         TxtDID = ""
         TxtBarcode = ""
         TxtDID.SetFocus
     End If
